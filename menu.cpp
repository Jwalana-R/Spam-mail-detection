...
label1:
    ...
    case 1:
    {
        ...
        for (auto i : fly)
        {
            ...
            {
                cout << endl
                     << " This FlightID has already been taken...Try using different FlightID..." << endl;
                goto label1;
            }
        }
...
label2:
    ...
    case 1:
    {
        ...
        for (auto i : users)
        {
            ...
            {
                cout << endl
                     << " This UserID has already been taken...Try using different UserID..." << endl;
                goto label2;
            }
        }
        u->set_userid(userid);
...
label5:
    ...
    case 1:
    {
        ...
        cin >> s2;
        cout << "\tEnter the boarding date (dd/mm/yyyy) : ";
        cin >> s3;
        int flag = 0;
        cout << endl
             << endl;
